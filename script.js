document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(30) hue-rotate(-40deg) brightness(0.9) contrast(0.8)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(30) hue-rotate(-40deg) brightness(0.9) contrast(0.8)'; // Adjusted filter values
    }
