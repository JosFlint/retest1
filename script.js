document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(50) hue-rotate(-32deg) brightness(0.9) contrast(0.6)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(50) hue-rotate(-32deg) brightness(0.9) contrast(0.6)'; // Adjusted filter values
    }
