document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(30) hue-rotate(-32deg) brightness(0.2) contrast(0.7)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(30) hue-rotate(-32deg) brightness(0.2) contrast(0.7)'; // Adjusted filter values
    }
