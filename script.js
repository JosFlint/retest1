document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(40) hue-rotate(-10deg) brightness(0,9) contrast(0.9)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(40) hue-rotate(-10deg) brightness(0.9) contrast(0.9)'; // Adjusted filter values
    }
