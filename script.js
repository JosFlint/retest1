document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(60) hue-rotate(-25deg) brightness(1.5) contrast(1.2)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(60) hue-rotate(-25deg) brightness(1.5) contrast(1.2)'; // Adjusted filter values
    }
