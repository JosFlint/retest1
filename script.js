document.addEventListener('DOMContentLoaded', () => {
    ...
    captureButton.addEventListener('click', () => {
        ...
        offScreenCtx.filter = 'sepia(1) saturate(40) hue-rotate(-25deg) brightness(1.2) contrast(1.2)'; // Adjusted filter values
    ...
    function applyFilter() {
        video.style.filter = 'sepia(1) saturate(40) hue-rotate(-25deg) brightness(1.2) contrast(1.2)'; // Adjusted filter values
    }
